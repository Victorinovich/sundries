...
$client.DownloadFile("https://cdn.zabbix.com/zabbix/binaries/stable/6.0/6.0.9/zabbix_agent-6.0.9-windows-amd64-openssl.msi", "$env:USERPROFILE\Downloads\zabbix_agent-6.0.9-windows-amd64-openssl.msi")
...
$hostname=read-host
$MYMSI="$env:USERPROFILE\Downloads\zabbix_agent-6.0.9-windows-amd64-openssl.msi"
